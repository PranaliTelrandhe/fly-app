...
const ModifySearchDetails = () => {
    ...
    return (
        <>
                ...
                <div className="container border border-dark  mt-2   rounded w-100">
                    <form className="d-flex m-2 " onSubmit={handleSubmit}>
                        ...
                        <div className="text-center ms-2 mt-4" >
                            <button className="btn btn-outline-info" style={{ width: 180, height: 37 }} type="submit">Search Flight</button>
                        </div>
            ...
            {isSubmitted &&(
                <>
                {/* <DateCarousel setDate={user.departureDate}/> */}
                <FlightSearchResult user={user}/>
